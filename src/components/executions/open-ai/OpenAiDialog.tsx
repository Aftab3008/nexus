...
interface Props {
  ...
  onSubmit: (values: OpenAiFormTypes) => void;
  defaultValues?: Partial<OpenAiFormTypes>;
}
...
export const OpenAiDialog = ({
  ...
  const form = useForm<OpenAiFormTypes>({
  ...
  const handleSubmit = (values: OpenAiFormTypes) => {
    onSubmit(values);
    onOpenChange(false);
  };
      ...
      <DialogContent>
        ...
        >
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid}>
                <FieldLabel htmlFor={field.name}>OpenAI Credential</FieldLabel>
                <Select
                  name={field.name}
                  value={field.value}
